...
class BuySellTextBoxes():
    ...
    def marketTextChanged(self,textBoxTotal,textBoxAmount,config,type):
        try:
            ...
            print(f"Exception thrown at function BuySellTextBoxes.marketTextChanged(): \n {ex}")
    ...
    def updateElement(self,ui,config,action):
        ...
        try:
            ...
            ui.console.append(f"Exception thrown at BuySellTextBoxes.updateElement(): \n{ex}")
    ...
    def updateBuySellTextBoxes(self,ui,config):
        try:
            ...
            ui.console.append(f"Exception thrown at BuySellTextBoxes.updateBuySellTextBoxes() : \n{ex}")
